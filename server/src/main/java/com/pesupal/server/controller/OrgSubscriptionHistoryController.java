...
public class OrgSubscriptionHistoryController {
    ...
    public ResponseEntity<ApiResponseDto> addSubscription(@RequestBody AddSubscriptionDto addSubscriptionDto) {

        Long orgId = RequestContext.getLong("X-ORG-ID");
        OrgSubscriptionHistory orgSubscriptionHistory = orgSubscriptionHistoryService.addSubscription(orgId, addSubscriptionDto);
